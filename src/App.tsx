...
import { useCharacterStore, useGameStore, useCollectionStore } from './stores';
...
import { Trophy, Zap, Swords, Brain, BarChart3, Map, BookOpen, ShoppingCart, Backpack } from 'lucide-react';
import type { Boss } from './types';

type ViewMode = 'main' | 'boss' | 'bossBattle' | 'skills' | 'achievements' | 'stats' | 'map' | 'story' | 'shop' | 'collection';
...
function App() {
  ...
  // 处理任务完成动画
  const handleQuestComplete = (exp: number, coins: number) => {
