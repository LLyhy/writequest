import type { ClassConfig, LevelConfig, Skill, Boss, Achievement, MapRegion, StoryChapter, ThemeSkin, FontEffect, Badge, InspirationFragment, WritingMaterial, AdventureStory, Equipment, LootBoxPrize, CharacterAppearance, CharacterStyle, CharacterGender, ArtStyle, SkinTone, HairColor, EyeColor, HairStyle, EyebrowStyle, NoseStyle, LipStyle, JawStyle } from '../types';
