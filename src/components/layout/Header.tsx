...
import { PenTool, Settings, LogOut, Home } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 py-3">
        <div className="flex items-center justify-between gap-4">
          ...
          >
            ...
            <a
              href="/"
              className="ml-2 flex items-center gap-1 px-2 py-1 text-xs text-gray-500 hover:text-pixel-accent transition-colors border border-pixel-border hover:border-pixel-accent rounded"
              title="返回首页"
            >
              <Home size={12} />
          ...
          {character ? (
            <motion.div
              className="flex items-center gap-6 flex-1 max-w-xl"
