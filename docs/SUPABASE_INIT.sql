-- =============================================
-- WriteQuest Supabase Database Setup
-- =============================================
...
CREATE POLICY "Users can create their own works" ON works
...
CREATE POLICY "Users can view comments on published works" ON comments
  FOR SELECT USING (
    EXISTS (
      SELECT 1 FROM works 
...
CREATE POLICY "Users can view views on published works" ON views
  FOR SELECT USING (
    EXISTS (
      SELECT 1 FROM works 
